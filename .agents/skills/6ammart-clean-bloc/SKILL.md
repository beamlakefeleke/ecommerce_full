...
description: Use this skill whenever writing, editing, reviewing, or migrating code in the 6amMart Flutter app (or any feature inside it). Applies to new features, GetX-to-BLoC migrations, refactors of existing controllers/repositories, adding API endpoints, or adding routes. Ensures all code follows feature-based Clean Architecture with BLoC state management instead of the legacy GetX pattern.
---
