          ...
          child: ResponsiveHelper.isDesktop(context) ?  Row(children: [
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                state.isPartialPay || state.paymentMethodIndex == 1 ? Row(children: [
                  Container(
                ...
                state.paymentMethodIndex == 1 ? Text(
            ...
            InkWell(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: state.isPartialPay || state.paymentMethodIndex == 1 ? Theme.of(context).cardColor : Theme.of(context).primaryColor,
                  border: Border.all(color: state.isPartialPay || state.paymentMethodIndex == 1 ? Colors.red : Theme.of(context).primaryColor, width: 0.5),
                  borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                ),
                padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall, horizontal: Dimensions.paddingSizeLarge),
                child: Text(
                  state.isPartialPay || state.paymentMethodIndex == 1 ? 'remove'.tr : 'use'.tr,
                  style: robotoBold.copyWith(fontSize: Dimensions.fontSizeDefault, color: state.isPartialPay || state.paymentMethodIndex == 1 ? Colors.red : Colors.white),
                ),
              ),
            ),
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(
                  state.isPartialPay ? 'has_paid_by_your_wallet'.tr : 'your_have_balance_in_your_wallet'.tr,
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Text(
                    state.isPartialPay || state.paymentMethodIndex == 1 ? 'remove'.tr : 'use'.tr,
                    style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: state.isPartialPay || state.paymentMethodIndex == 1 ? Colors.red : Colors.white),
                  ),
                ),
              ),
