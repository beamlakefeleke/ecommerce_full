...
import 'package:ecommerce/features/checkout/widgets/guest_delivery_address.dart';
          ...
          isGuestLoggedIn ? GuestDeliveryAddress(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                TextButton.icon(
                  onPressed: () async {
                    var address = await Get.toNamed(RouteHelper.getAddAddressRoute(true, false, state.store!.zoneId));
                    if(address != null) {
                      context.read<CheckoutBloc>().add(DistanceCalculated(
                        origin: LatLng(double.parse(address.latitude), double.parse(address.longitude)),
                        destination: LatLng(double.parse(state.store!.latitude!), double.parse(state.store!.longitude!)),
                      ));
              ...
              isDesktop ?  Stack(children: [
                Container(
                  ...
                  child: Container(
                    ...
                    child: AddressWidget(
                      address: address[state.addressIndex!],
                        ...
                        itemBuilder: (context)  => List.generate(
                          ...
                          child: InkWell(
                            onTap: () {
                              ...
                              context.read<CheckoutBloc>().add(AddressIndexSet(index: index));
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(color: state.addressIndex == index ? Theme.of(context).primaryColor : Theme.of(context).disabledColor),
                                    ),
                                    child: state.addressIndex == index ? Container(
                                      height: 15, width: 15,
