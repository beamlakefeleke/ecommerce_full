...
import 'package:ecommerce/features/checkout/widgets/time_slot_bottom_sheet.dart';
...
class TimeSlotSection extends StatelessWidget {
  ...
  final Module? module;
  const TimeSlotSection({super.key, this.storeId, this.cartList, required this.tooltipController2,
    ...
    return BlocBuilder<CheckoutBloc, CheckoutState>(
      builder: (context, state) {
        return Column(children: [
          !isGuestLoggedIn && storeId == null && state.store != null && state.store!.scheduleOrder! && cartList!.isNotEmpty && cartList![0]!.item!.availableDateStarts == null ? Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: ((state.selectedDateSlot == 0 && todayClosed) || (state.selectedDateSlot == 1 && tomorrowClosed))
                    ? Center(child: Text(module!.showRestaurantText! ? 'restaurant_is_closed'.tr : 'store_is_closed'.tr))
                    : Text(state.preferableTime.isNotEmpty ? state.preferableTime : 'instance'.tr),
                ),
          ...
          SizedBox(height: !isGuestLoggedIn && storeId == null && state.store != null && state.store!.scheduleOrder! && cartList!.isNotEmpty && cartList![0]!.item!.availableDateStarts == null ? Dimensions.paddingSizeSmall : 0),
