        ...
        child: BlocBuilder<CheckoutBloc, CheckoutState>(
            builder: (context, state) {
              return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: (){
                        context.read<CheckoutBloc>().add(const ExpandToggled());
                      },
                      icon: Icon(state.isExpanded ?  Icons.keyboard_arrow_up : Icons.keyboard_arrow_down)
                    )
                  ],
                ),

                !state.isExpanded ? const SizedBox() :
                GridView.builder(
                ...
                !state.isExpanded ? const SizedBox() : const SizedBox( height: Dimensions.paddingSizeSmall),
