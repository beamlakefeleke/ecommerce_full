...
class FundBonusModel extends FundBonus {
  ...
  FundBonusModel({
    ...
    super.bonusType,
    super.bonusAmount,
    super.minimumAddAmount,
    super.maximumBonusAmount,
    super.startDate,
    super.endDate,
    super.status,
    super.createdAt,
  ...
  factory FundBonusModel.fromJson(Map<String, dynamic> json) {
    List<Translations>? translations;
