        ...
        onPressed: () async {
          ...
          if(complete) {
            ...
            if(widget.forParcel) {
              ...
              final result = await getIt<PlaceOrderUseCase>()(widget.placeOrderBody, getIt<CheckoutBloc>().state.orderAttachment);
              orderId = result.fold((l) {
                showCustomSnackBar(l.message);
                return '';
              }, (id) {
