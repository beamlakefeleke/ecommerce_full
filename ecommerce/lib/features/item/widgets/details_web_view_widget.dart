                      ...
                      children: [
                        ...
                        Row(children: [
                          ...
                          BlocBuilder<CartBloc, CartState>(bloc: getIt<CartBloc>(), builder: (context, cartState) {
                            return Row(children: [
                              QuantityButton(
                                isIncrement: false, quantity: itemController.cartIndex != -1 ? cartState.cartList[itemController.cartIndex].quantity : itemController.quantity,
                                stock: stock, isExistInCart : itemController.cartIndex != -1, cartIndex: itemController.cartIndex,
                                quantityLimit : itemController.cartIndex != -1 ? cartState.cartList[itemController.cartIndex].quantityLimit : itemController.item!.quantityLimit,
                                
                              ),
                              const SizedBox(width: 30),

                              Text(
                                itemController.cartIndex != -1 ? cartState.cartList[itemController.cartIndex].quantity.toString() : itemController.quantity.toString(),
                                style: robotoBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge),
                              ),
                              const SizedBox(width: 30),

                              QuantityButton(
                                isIncrement: true, quantity: itemController.cartIndex != -1 ? cartState.cartList[itemController.cartIndex].quantity : itemController.quantity,
                            ...
                            builder: (context, cartState) {
                              return CustomButton(
                                ...
                                onPressed: (!Get.find<SplashController>().configModel!.moduleConfig!.module!.stock! || stock! > 0) ?  () async {
                                  ...
                                  }else if (getIt<CartServiceInterface>().existAnotherStoreItem(cartModel!.item!.storeId, Get.find<SplashController>().module!.id, getIt<CartBloc>().state.cartList)) {
