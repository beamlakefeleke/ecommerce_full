...
import 'package:ecommerce/common/widgets/organic_tag.dart';
                    ...
                    return InkWell(
                      onTap: () {
                        if(AuthHelper.isLoggedIn()){
                          if(state.wishItemIdList.contains(itemController.item!.id)) {
                            getIt<FavouriteBloc>().add(FavouriteRemoved(id: itemController.item!.id, isStore: false));
                          }else {
                            getIt<FavouriteBloc>().add(FavouriteAdded(item: itemController.item, store: null, isStore: false));
                          }
                        }else {
                      ...
                      child: Icon(
                        state.wishItemIdList.contains(itemController.item!.id) ? Icons.favorite : Icons.favorite_border, size: 25,
        ...
        builder: (itemController) {
          return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              item!.availableTimeStarts != null ? const SizedBox() : BlocBuilder<FavouriteBloc, FavouriteState>(
                  builder: (state) {
                    return Row(
                      children: [
                        // Text(
                        ...
                        InkWell(
                          onTap: () {
                            if(isLoggedIn){
                              if(state.wishItemIdList.contains(item!.id)) {
                                getIt<FavouriteBloc>().add(FavouriteRemoved(id: item!.id, isStore: false));
                              }else {
                          ...
                          child: Icon(
                            state.wishItemIdList.contains(item!.id) ? Icons.favorite : Icons.favorite_border, size: 25,
                            color: Theme.of(context).primaryColor,
                          ),
                        ),
                      ],
