...
import 'package:ecommerce/features/search/controllers/search_controller.dart' as search;
...
import 'package:ecommerce/features/search/widgets/filter_widget.dart';
import 'package:ecommerce/features/search/widgets/search_field_widget.dart';
import 'package:ecommerce/features/search/widgets/search_result_widget.dart';
...
import 'package:ecommerce/features/store/widgets/bottom_cart_widget.dart';
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BlocBuilder<CartBloc, CartState>(bloc: getIt<CartBloc>(), builder: (context, cartState) {
          return cartState.cartList.isNotEmpty && !ResponsiveHelper.isDesktop(context) ? const BottomCartWidget() : const SizedBox();
        })
      ),
    );
  }
