...
import 'package:ecommerce/common/widgets/card_design/store_card.dart';
import 'package:ecommerce/common/widgets/card_design/store_card_with_distance.dart';
...
import 'package:ecommerce/common/widgets/title_widget.dart';
                           ...
                           /* AddFavouriteView(
                            ...
                            Positioned(
                              ...
                              child: BlocBuilder<FavouriteBloc, FavouriteState>(builder: (context, state) {
                                bool isWished = state.wishStoreIdList.contains(storeList[index].id);
                                return InkWell(
                                  onTap: () {
                                    if(AuthHelper.isLoggedIn()) {
                                      isWished ? getIt<FavouriteBloc>().add(FavouriteRemoved(id: storeList[index].id, isStore: true))
                                          : getIt<FavouriteBloc>().add(FavouriteAdded(item: null, store: storeList[index], isStore: true));
                                    }else {
