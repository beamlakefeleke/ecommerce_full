    ...
    return SizedBox(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        GetBuilder<StoreController>(builder: (storeController) {
          ...
          return storeController.cartSuggestItemModel != null && suggestedItems!.isNotEmpty ? BlocBuilder<CartBloc, CartState>(bloc: getIt<CartBloc>(),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: PageView.builder (
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Stack(
                          children: [
                            ...
                            cartState.currentIndex != 0 ? Positioned(
                            ...
                            cartState.currentIndex != ((suggestedItems.length/4).ceil()-1) ? Positioned(
                      ...
                      onPageChanged: (int index) => getIt<CartBloc>().add(SetCurrentIndexEvent(index)),
                    )
                  ),
                ],
              );
